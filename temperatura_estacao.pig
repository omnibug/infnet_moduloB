...
t2 = FILTER t1 BY stid == $id_estacao;
...
sources = FILTER s1 BY scid is not null and stid == $id_estacao;
...
STORE medicoes_ordenadas INTO 'infnet/results/temperatura_estacao_$id_estacao' USING PigStorage(';');
